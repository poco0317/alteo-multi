...
import com.etterna.multi.socket.ettpmessage.client.payload.ReplayHolddropMessage;
import com.etterna.multi.socket.ettpmessage.server.payload.GameplayReplayUpdateMessage;

@Component
public class ReplayHolddropHandler extends EttpMessageHandler {
	
	@Override
	public void handle(WebSocketSession session, EttpMessage message) throws IOException {
		ReplayHolddropMessage msg = readPayload(message, ReplayHolddropMessage.class);

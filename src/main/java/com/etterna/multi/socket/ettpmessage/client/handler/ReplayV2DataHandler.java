...
import com.etterna.multi.socket.ettpmessage.client.payload.ReplayV2DataMessage;
import com.etterna.multi.socket.ettpmessage.server.payload.GameplayReplayUpdateMessage;

@Component
public class ReplayV2DataHandler extends EttpMessageHandler {
	
	@Override
	public void handle(WebSocketSession session, EttpMessage message) throws IOException {
		ReplayV2DataMessage msg = readPayload(message, ReplayV2DataMessage.class);
